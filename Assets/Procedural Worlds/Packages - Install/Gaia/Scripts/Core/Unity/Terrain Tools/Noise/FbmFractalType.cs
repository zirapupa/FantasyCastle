...
namespace Gaia
{
    ...
    public class FbmFractalType : FractalType<FbmFractalType>
    {
        ...
        public override string DoGUI(Rect rect, string serializedString)
        {
            ...
            {
                rect.y += EditorGUIUtility.singleLineHeight;
                EditorGUI.HelpBox(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight*2f), "Lacunarity Values close to 1 can lead to blurry noise patterns in combination with high scale values!", MessageType.Warning);
                rect.y += EditorGUIUtility.singleLineHeight;
            }
