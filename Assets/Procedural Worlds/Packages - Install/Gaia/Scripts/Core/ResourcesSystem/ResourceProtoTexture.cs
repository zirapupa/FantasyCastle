...
namespace Gaia
{
    ...
    public class ResourceProtoTexture
    {
        ...
        [SerializeField]
        private TerrainLayer m_currentLayer;
        ...
        public TerrainLayer CurrentLayer
        {
            get
            {
                ...
                {
                    if (!string.IsNullOrEmpty(m_LayerGUID))
                    {
#if UNITY_EDITOR
                        m_currentLayer = AssetDatabase.LoadAssetAtPath<TerrainLayer>(AssetDatabase.GUIDToAssetPath(m_LayerGUID));
#endif
                    }
                }
            ...
            set
            {
                if (value != null && value != m_currentLayer)
                {
#if UNITY_EDITOR
                    m_LayerGUID = AssetDatabase.GUIDFromAssetPath(AssetDatabase.GetAssetPath(value)).ToString();
#endif
